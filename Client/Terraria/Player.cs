			...
			if (item.hammer > 0 && num5 == -1 && num6 == -1)
			{
				...
				while (list6.Count > 0)
				{
					...
					else
					{
						...
						//EDIT: Main.tile[tuple8.Item1, tuple8.Item2];
		...
		public void UpdatePlayer(int i)
		{
				...
				if (this.position.X / 16f - (float)Player.tileRangeX <= (float)Player.tileTargetX && (this.position.X + (float)this.width) / 16f + (float)Player.tileRangeX - 1f >= (float)Player.tileTargetX && this.position.Y / 16f - (float)Player.tileRangeY <= (float)Player.tileTargetY && (this.position.Y + (float)this.height) / 16f + (float)Player.tileRangeY - 2f >= (float)Player.tileTargetY)
				{
					...
					if (Main.tile[Player.tileTargetX, Player.tileTargetY].active())
					{
						...
						if (Main.tile[Player.tileTargetX, Player.tileTargetY].type == 79)
						{
							this.noThrow = 2;
							this.showItemIcon = true;
							int num84 = Main.tile[Player.tileTargetX, Player.tileTargetY].frameY / 36;
							if (num84 == 0)
							{
							...
							else if (num84 >= 13 && num84 <= 18)
							{
								this.showItemIcon2 = 2066 + num84 - 13;
							}
							else if (num84 >= 19 && num84 <= 20)
							{
						...
						if (Main.tile[Player.tileTargetX, Player.tileTargetY].type == 209)
						{
							...
							int num85;
							for (num85 = Main.tile[Player.tileTargetX, Player.tileTargetY].frameX / 18; num85 >= 4; num85 -= 4)
							{
							}
							if (num85 < 2)
							{
						...
						if (Main.tile[Player.tileTargetX, Player.tileTargetY].type == 21)
						{
							...
							else
							{
								...
								{
									this.showItemIcon2 = Chest.typeToIcon[tile.frameX / 36];
						...
						if (Main.tile[Player.tileTargetX, Player.tileTargetY].type == 4)
						{
							this.noThrow = 2;
							this.showItemIcon = true;
							int num91 = Main.tile[Player.tileTargetX, Player.tileTargetY].frameY / 22;
							if (num91 == 0)
							{
						...
						if (Main.tile[Player.tileTargetX, Player.tileTargetY].type == 13)
						{
							this.noThrow = 2;
							this.showItemIcon = true;
							int num92 = Main.tile[Player.tileTargetX, Player.tileTargetY].frameX / 18;
							if (num92 == 1)
							{
						...
						if (Main.tile[Player.tileTargetX, Player.tileTargetY].type == 33)
						{
							...
							int num93 = Main.tile[Player.tileTargetX, Player.tileTargetY].frameY / 22;
							if (num93 == 1)
							{
						...
						if (Main.tile[Player.tileTargetX, Player.tileTargetY].type == 139)
						{
							...
							int num96 = 0;
							for (int num97 = Main.tile[num94, num95].frameY / 18; num97 >= 2; num97 -= 2)
							{
								num96++;
							}
							this.showItemIcon = true;
						...
						if (Main.tile[Player.tileTargetX, Player.tileTargetY].type == 207)
						{
							...
							int num100 = 0;
							for (int num101 = Main.tile[num98, num99].frameX / 18; num101 >= 2; num101 -= 2)
							{
								num100++;
							}
							this.showItemIcon = true;
						...
						{
							this.noThrow = 2;
							int num102 = Main.tile[Player.tileTargetX, Player.tileTargetY].frameX / 18;
							int num103 = Main.tile[Player.tileTargetX, Player.tileTargetY].frameY / 18;
							while (num102 > 1)
							{
								num102 -= 2;
							}
						...
						if (Main.tile[Player.tileTargetX, Player.tileTargetY].type == 88)
						{
							this.noThrow = 2;
							this.showItemIcon = true;
							int num106 = Main.tile[Player.tileTargetX, Player.tileTargetY].frameX / 54;
							if (num106 == 0)
							{
						...
						if (this.controlUseTile)
						{
							if (Main.tile[Player.tileTargetX, Player.tileTargetY].type == 212 && this.launcherWait <= 0)
							{
								...
								if (flag15)
								{
									...
									int num112 = Main.tile[num109, num110].frameX / 18;
									int num113 = 0;
									while (num112 >= 3)
									{
										num113++;
									...
									int num114;
									for (num114 = Main.tile[num109, num110].frameY / 18; num114 >= 3; num114 -= 3)
									{
									}
							...
							if (this.releaseUseTile)
							{
								...
								else if (Main.tile[Player.tileTargetX, Player.tileTargetY].type == 79)
								{
									...
									num128 += Main.tile[Player.tileTargetX, Player.tileTargetY].frameX / 18 * -1;
									if (Main.tile[Player.tileTargetX, Player.tileTargetY].frameX >= 72)
									{
										num128 += 4;
										num128++;
									...
									int num130 = Main.tile[Player.tileTargetX, Player.tileTargetY].frameY / 18;
									int num131 = 0;
									while (num130 > 1)
									{
										num130 -= 2;
								...
								else if (Main.tile[Player.tileTargetX, Player.tileTargetY].type == 55 || Main.tile[Player.tileTargetX, Player.tileTargetY].type == 85)
								{
									...
									if (flag17)
									{
										...
										{
											int num134 = Main.tile[Player.tileTargetX, Player.tileTargetY].frameX / 18;
											int num135 = Main.tile[Player.tileTargetX, Player.tileTargetY].frameY / 18;
											while (num134 > 1)
											{
												num134 -= 2;
											}
								...
								else if ((Main.tile[Player.tileTargetX, Player.tileTargetY].type == 21 || Main.tile[Player.tileTargetX, Player.tileTargetY].type == 29 || Main.tile[Player.tileTargetX, Player.tileTargetY].type == 97) && this.talkNPC == -1)
								{
									...
									int num147 = 0;
									int num148;
									for (num148 = Main.tile[Player.tileTargetX, Player.tileTargetY].frameX / 18; num148 > 1; num148 -= 2)
									{
									}
									num148 = Player.tileTargetX - num148;
									int num149 = Player.tileTargetY - Main.tile[Player.tileTargetX, Player.tileTargetY].frameY / 18;
									if (Main.tile[Player.tileTargetX, Player.tileTargetY].type == 29)
									{
										num147 = 1;
									}
									...
									else
									{
										...
										else
										{
											...
											if ((Main.tile[num148, num149].frameX >= 72 && Main.tile[num148, num149].frameX <= 106) || (Main.tile[num148, num149].frameX >= 144 && Main.tile[num148, num149].frameX <= 178) || (Main.tile[num148, num149].frameX >= 828 && Main.tile[num148, num149].frameX <= 1006) || (Main.tile[num148, num149].frameX >= 1296 && Main.tile[num148, num149].frameX <= 1330) || (Main.tile[num148, num149].frameX >= 1368 && Main.tile[num148, num149].frameX <= 1402) || (Main.tile[num148, num149].frameX >= 1440 && Main.tile[num148, num149].frameX <= 1474))
											{
												...
												{
													int num152 = Main.tile[num148, num149].frameX / 18;
													int num153 = 0;
													while (num152 >= 2)
													{
														num152 -= 2;
										...
										if (num150 != -1)
										{
											...
											else if (num150 != this.chest && this.chest == -1)
											{
												this.chest = num150;
												Main.playerInventory = true;
												Main.PlaySound(10, -1, -1, 1);
				...
				else
				{
					...
					if (Main.tile[Player.tileTargetX, Player.tileTargetY].type == 21)
					{
						...
						else
						{
							...
							{
								this.showItemIcon2 = Chest.typeToIcon[tile2.frameX / 36];
								this.showItemIconText = "";
							}
						}
						this.noThrow = 2;
			...
			if (Main.myPlayer == this.whoAmi)
			{
				...
				else if (vector6.Y == 15f)
				{
					...
					{
						this.suffocateDelay = (byte)(this.suffocateDelay + 1);
					}
					else
					{
			...
			if (this.wetSlime > 0)
			{
				this.wetSlime = (byte)(this.wetSlime - 1);
			}
						...
						if (WorldGen.PlaceTile(Player.tileTargetX, Player.tileTargetY, this.inventory[this.selectedItem].createTile, false, forced, this.whoAmi, num48))
						{
							...
							if (this.inventory[this.selectedItem].createTile == 15)
							{
								if (this.direction == 1)
								{
									...
									expr_30DB.frameX = (short)(expr_30DB.frameX + 18);
									Tile expr_3100 = Main.tile[Player.tileTargetX, Player.tileTargetY - 1];
									expr_3100.frameX = (short)(expr_3100.frameX + 18);
								}
								if (Main.netMode == 1)
								{
							...
							else if (this.inventory[this.selectedItem].createTile == 137)
							{
								if (this.direction == 1)
								{
									...
									expr_316A.frameX = (short)(expr_316A.frameX + 18);
								}
								if (Main.netMode == 1)
								{
