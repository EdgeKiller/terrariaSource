	...
	public class Map
	{
		...
		public byte color
		{
			...
			set
			{
				...
				this.misc = (byte)((this.misc & 224) | (int)value);
			}
		}
		public Map()
		{
		...
		public void setTile(int i, int j, byte Light)
		{
			...
			if (num5 == 0)
			{
				...
				else if (j < Main.maxTilesY - 200)
				{
					...
					{
						num5 = Map.dirtPosition + (ushort)b;
					}
					else
					{
						num5 = Map.rockPosition + (ushort)b;
					}
				}
				else
				{
			...
			for (int i = 0; i < Main.maxTilesX; i++)
			{
				...
				for (int j = 0; j < Main.maxTilesY; j++)
				{
					...
					if (flag)
					{
						...
						{
							num7 = Map.liquidPosition + 1;
						}
						else if (oldMapHelper.honey())
						{
							num7 = Map.liquidPosition + 2;
						}
		...
		private static void loadMap_Version2(BinaryReader fileIO, int release)
		{
			...
			for (int i = 0; i < (int)num4; i++)
			{
				...
				num10 = (ushort)(num10 + (ushort)array3[i]);
			}
			...
			for (int i = 0; i < (int)num5; i++)
			{
				...
				num11 = (ushort)(num11 + (ushort)array4[i]);
			}
			int num12 = num10 + num11 + (int)num6 + (int)num7 + (int)num8 + (int)num9 + 2;
			...
			for (int i = 0; i < 340; i++)
			{
				...
				{
					num13 = (ushort)(num13 + (ushort)Map.tileOptionCounts[i]);
				}
			}
			ushort num18 = num14;
			for (int i = 0; i < 172; i++)
			{
				...
				{
					num13 = (ushort)(num13 + (ushort)Map.wallOptionCounts[i]);
				}
			}
			ushort num21 = num14;
			for (int i = 0; i < 3; i++)
				...
				for (int m = 0; m < Main.maxTilesX; m++)
				{
					...
					else
					{
						...
						case 7:
							...
							{
								num27 = (ushort)(num27 + num23);
							}
							else
							{
								num27 = (ushort)(num27 + num24);
							}
							break;
						}
						Map map = new Map();
							...
							for (int j = 0; j < Main.maxTilesY; j++)
							{
								...
								for (int k = 0; k < Main.maxTilesX; k++)
								{
									...
									else
									{
										...
										{
											num5 = 1;
											num6 = (ushort)(num6 - Map.tilePosition);
										}
										else if (num6 < Map.liquidPosition)
										{
											num5 = 2;
											num6 = (ushort)(num6 - Map.wallPosition);
										}
										else if (num6 < Map.skyPosition)
										{
											num5 = 3 + (num6 - Map.liquidPosition);
											flag3 = false;
										}
										else if (num6 < Map.dirtPosition)
										{
											num5 = 6;
											flag4 = false;
											flag3 = false;
										}
										else if (num6 < Map.hellPosition)
										{
											num5 = 7;
											if (num6 < Map.rockPosition)
											{
												num6 = (ushort)(num6 - Map.dirtPosition);
											}
											else
											{
												num6 = (ushort)(num6 - Map.rockPosition);
											}
										}
										else
										{
