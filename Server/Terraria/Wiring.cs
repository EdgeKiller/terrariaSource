	...
	public static class Wiring
	{
		...
		public static void UpdateMech()
		{
			for (int i = Wiring.numMechs - 1; i >= 0; i--)
			{
				...
				if (Main.tile[Wiring.mechX[i], Wiring.mechY[i]].active() && Main.tile[Wiring.mechX[i], Wiring.mechY[i]].type == 144)
				{
					...
					{
						int num = Main.tile[Wiring.mechX[i], Wiring.mechY[i]].frameX / 18;
						if (num == 0)
						{
							num = 60;
						}
				...
				for (int k = num2; k < num2 + 2; k++)
				{
					for (int l = num3; l < num3 + 2; l++)
					{
						if (Main.tile[k, l].type == 132)
						{
							...
							expr_1D3.frameX = (short)(expr_1D3.frameX + num);
						}
					}
				}
					...
					for (int j = 0; j < Wiring.numOutPump; j++)
					{
						...
						if (liquid2 < 255)
						{
							...
							if (flag == flag3 && flag2 == flag4)
							{
								...
								expr_102.liquid = (byte)(expr_102.liquid + (byte)num5);
								Tile expr_11E = Main.tile[num, num2];
								expr_11E.liquid = (byte)(expr_11E.liquid - (byte)num5);
		...
		private static bool hitWireSingle(int i, int j)
		{
			...
			if (tile.active() && type >= 255 && type <= 268)
			{
				...
				{
					Tile expr_35 = tile;
					expr_35.type = (ushort)(expr_35.type - 7);
				}
				else
				{
					Tile expr_46 = tile;
					expr_46.type = (ushort)(expr_46.type + 7);
				}
			...
			if (tile.active())
			{
				...
				{
					int num4 = j - tile.frameY / 18;
					int num5 = i - tile.frameX / 18;
				...
				else if (type == 4)
				{
					...
					{
						Tile expr_491 = tile;
						expr_491.frameX = (short)(expr_491.frameX + 66);
					}
					else
					{
						Tile expr_4A3 = tile;
						expr_4A3.frameX = (short)(expr_4A3.frameX - 66);
					}
					NetMessage.SendTileSquare(-1, i, j, 1);
				}
				else if (type == 149)
				{
					...
					{
						Tile expr_4D3 = tile;
						expr_4D3.frameX = (short)(expr_4D3.frameX + 54);
					}
					else
					{
						Tile expr_4E5 = tile;
						expr_4E5.frameX = (short)(expr_4E5.frameX - 54);
					}
					NetMessage.SendTileSquare(-1, i, j, 1);
				}
				else if (type == 244)
				{
					int l;
					for (l = tile.frameX / 18; l >= 3; l -= 3)
					{
					}
					int m;
					for (m = tile.frameY / 18; m >= 3; m -= 3)
					{
					}
					int num7 = i - l;
					int num8 = j - m;
				...
				{
					int num11;
					for (num11 = tile.frameY / 18; num11 >= 2; num11 -= 2)
					{
					}
					int num12 = j - num11;
					short num13 = 18;
					...
					expr_60C.frameX = (short)(expr_60C.frameX + num13);
					Tile expr_62A = Main.tile[i, num12 + 1];
					expr_62A.frameX = (short)(expr_62A.frameX + num13);
				...
				{
					int num14;
					for (num14 = tile.frameY / 18; num14 >= 3; num14 -= 3)
					{
					}
					num14 = j - num14;
					short num15 = 18;
					...
					expr_69D.frameX = (short)(expr_69D.frameX + num15);
					Tile expr_6BB = Main.tile[i, num14 + 1];
					expr_6BB.frameX = (short)(expr_6BB.frameX + num15);
					Tile expr_6D9 = Main.tile[i, num14 + 2];
					expr_6D9.frameX = (short)(expr_6D9.frameX + num15);
				...
				{
					int num16;
					for (num16 = tile.frameY / 18; num16 >= 2; num16 -= 2)
					{
					}
					num16 = j - num16;
					...
					expr_795.frameX = (short)(expr_795.frameX + num18);
					Tile expr_7B4 = Main.tile[num17, num16 + 1];
					expr_7B4.frameX = (short)(expr_7B4.frameX + num18);
					Tile expr_7D3 = Main.tile[num17 + 1, num16];
					expr_7D3.frameX = (short)(expr_7D3.frameX + num18);
					Tile expr_7F4 = Main.tile[num17 + 1, num16 + 1];
					expr_7F4.frameX = (short)(expr_7F4.frameX + num18);
				...
				{
					int num19;
					for (num19 = tile.frameY / 18; num19 >= 3; num19 -= 3)
					{
					}
					int num20 = j - num19;
					...
					for (int num23 = num21; num23 < num21 + 3; num23++)
					{
						for (int num24 = num20; num24 < num20 + 3; num24++)
						{
							...
							expr_8B9.frameX = (short)(expr_8B9.frameX + num22);
				...
				else if (type == 33 || type == 174)
				{
					...
					Tile expr_941 = tile;
					expr_941.frameX = (short)(expr_941.frameX + num25);
					NetMessage.SendTileSquare(-1, i, j, 3);
				}
				else if (type == 92)
				{
					int num26 = j - tile.frameY / 18;
					short num27 = 18;
					if (tile.frameX > 0)
					{
						num27 = -18;
					...
					{
						Tile expr_994 = Main.tile[i, num28];
						expr_994.frameX = (short)(expr_994.frameX + num27);
