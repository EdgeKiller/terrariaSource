					...
					if (tile.active())
					{
						...
						if (Main.tileLighted[(int)tile.type])
						{
							...
							else if (type <= 318)
							{
								...
								case 318:
								{
									int num37 = m - tile.frameX / 18;
									int num38 = n - tile.frameY / 18;
									int num39 = num37 / 2 * (num38 / 3);
									num39 %= Main.cageFrames;
									bool flag = Main.jellyfishCageMode[tile.type - 316, num39] == 2;
									if (tile.type == 316)
									{
										if (flag)
										{
