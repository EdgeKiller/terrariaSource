...
namespace Terraria
{
	public class Framing
	{
		...
		public static void Add8WayLookup(int lookup, short point1X, short point1Y, short point2X, short point2Y, short point3X, short point3Y)
		{
			...
			{
				new Point16(point1X * Framing.frameSize8Way.x, point1Y * Framing.frameSize8Way.y),
				new Point16(point2X * Framing.frameSize8Way.x, point2Y * Framing.frameSize8Way.y),
				new Point16(point3X * Framing.frameSize8Way.x, point3Y * Framing.frameSize8Way.y)
			};
		...
		public static void Add8WayLookup(int lookup, short x, short y)
		{
			Point16[] array = new Point16[]
			{
				new Point16(x * Framing.frameSize8Way.x, y * Framing.frameSize8Way.y),
				new Point16(x * Framing.frameSize8Way.x, y * Framing.frameSize8Way.y),
				new Point16(x * Framing.frameSize8Way.x, y * Framing.frameSize8Way.y)
			};
			Framing.selfFrame8WayLookup[lookup] = array;
		...
		public static void AddWallFrameLookup(int lookup, short point1X, short point1Y, short point2X, short point2Y, short point3X, short point3Y, short point4X, short point4Y)
		{
			Point16[] array = new Point16[]
			{
				new Point16(point1X * Framing.wallFrameSize.x, point1Y * Framing.wallFrameSize.y),
				new Point16(point2X * Framing.wallFrameSize.x, point2Y * Framing.wallFrameSize.y),
				new Point16(point3X * Framing.wallFrameSize.x, point3Y * Framing.wallFrameSize.y),
				new Point16(point4X * Framing.wallFrameSize.x, point4Y * Framing.wallFrameSize.y)
			};
